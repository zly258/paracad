...
本项目建议至少维持三类代理并行协作：
1. **内核与节点代理**：负责将 computeGraph 抽象为 occtKernel，扩展节点库，编写 occtBridge、nodes/index.ts。
...
## 交付物
- **节点代理**：节点清单、occtBridge、geometryEngine 模块；输出文档可放在 docs/architecture.md 的 节点引擎部分。
